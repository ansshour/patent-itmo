        ...
        <>
            ...
            <div className={styles.results}>
                ...
                <div className={styles.projectCards}>
                    {normaliseResults(searchResult).map(({ title, description, MPK, document, inventor, applicant }) => (
                        <PatentCard title={title} description={description} MPK={MPK} document={document} inventors={inventor} applicants={applicant} />
                    ))}
                </div>
            </div>
        </>
